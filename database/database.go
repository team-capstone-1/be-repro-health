...
func CreateOrUpdateArticle(title, content, image string, doctorID uuid.UUID) error {
	...
	article := &model.Article{
		...
		Image:     image,
		DoctorID:  doctorID,
		Published: true, // Jika dinyatakan di sini, pastikan ini sesuai dengan logika bisnis Anda.
