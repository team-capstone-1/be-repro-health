...
func New() *echo.Echo {
	...
	doctor.POST("/profile/work-histories", controller.CreateDoctorWorkHistoryController, m.CheckRole("doctor"))
	doctor.PUT("/profile/work-histories/:id", controller.UpdateDoctorWorkHistoryController, m.CheckRole("doctor"))
