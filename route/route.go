...
func New() *echo.Echo {
	...
	doctor.GET("/articles", controller.GetAllArticleDoctorsController)
	doctor.POST("/articles", controller.CreateDoctorArticleController)
	doctor.DELETE("/articles/:id", controller.DeleteDoctorArticleController)
